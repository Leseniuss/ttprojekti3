...
class LuminosityAnalyzer2(private val listener: LumaListener2) : ImageAnalysis.Analyzer {
    ...
    override fun analyze(image: ImageProxy) {
        ...
        if (deltaTime >= intervalInMilliSeconds) {
            ...
            val luma2 = pixels.average()
           // Log.d("PERKELE2222222", "Average luminosityyyyyy: $luma")
